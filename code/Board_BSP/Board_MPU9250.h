...
#define MPU6500_ID				0x73//0X73  	//MPU6500的器件ID
...
#define MPU_CFG_REG				0X1A	//配置寄存器,CONFIG
#define MPU_GYRO_CFG_REG		0X1B	//陀螺仪配置寄存器,GYRO_CONFIG
#define MPU_ACCEL_CFG_REG		0X1C	//加速度计配置寄存器,ACCEL_CONFIG
#define MPU_ACCEL_CFG_REG_2 0x1D  //ACCEL_CONFIG 2
#define MPU_LP_ACCEL_ODR 0x1E  //LP_ACCEL_ODR
#define MPU_MOTION_DET_REG		0X1F	//运动检测阀值设置寄存器,WOM_THR
