 ...
 *      DEFINES
 *********************/
#define GUI_COORD_MAX     (16383)    /*To avoid overflow don't let the max [-32,32k] range */
#define GUI_COORD_MIN     (-16384)
/**********************
 *      TYPEDEFS
 **********************/
 ...
 */
static inline coord_t area_get_width(const area_t * area_p)
{
 ...
 */
static inline coord_t area_get_height(const area_t * area_p)
{
