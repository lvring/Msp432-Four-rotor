 ...
 */
void area_set(area_t * area_p, coord_t x1, coord_t y1, coord_t x2, coord_t y2)
{
    area_p->x1 = x1;
    area_p->y1 = y1;
    area_p->x2 = x2;
 ...
 */
void area_set_width(area_t * area_p, coord_t w)
{
 ...
 */
void area_set_height(area_t * area_p, coord_t h)
{
 ...
 */
void area_set_pos(area_t * area_p, coord_t x, coord_t y)
{
...
bool area_union(area_t * res_p, const area_t * a1_p, const area_t * a2_p)
{
    ...
    res_p->x1 = RTE_MATH_MAX(a1_p->x1, a2_p->x1);
    res_p->y1 = RTE_MATH_MAX(a1_p->y1, a2_p->y1);
    res_p->x2 = RTE_MATH_MIN(a1_p->x2, a2_p->x2);
    res_p->y2 = RTE_MATH_MIN(a1_p->y2, a2_p->y2);
...
{
    a_res_p->x1 = RTE_MATH_MIN(a1_p->x1, a2_p->x1);
    a_res_p->y1 = RTE_MATH_MIN(a1_p->y1, a2_p->y1);
    a_res_p->x2 = RTE_MATH_MAX(a1_p->x2, a2_p->x2);
    a_res_p->y2 = RTE_MATH_MAX(a1_p->y2, a2_p->y2);
}
