...
void font_init(void)
{
...
#if USE_FONT_DEJAVU_10_LATIN_SUP != 0
#if USE_FONT_DEJAVU_10 != 0
    font_add(&font_dejavu_10_latin_sup, &font_dejavu_10);
#else
    font_add(&font_dejavu_10_latin_sup, NULL);
#endif
#endif
    ...
    /*SYMBOL 10*/
#if USE_FONT_SYMBOL_10 != 0
#if USE_FONT_DEJAVU_10 != 0
    font_add(&font_symbol_10, &font_dejavu_10);
#else
    font_add(&font_symbol_10, NULL);
#endif
#endif
...
#if USE_FONT_DEJAVU_20_LATIN_SUP != 0
#if USE_FONT_DEJAVU_20 != 0
    font_add(&font_dejavu_20_latin_sup, &font_dejavu_20);
#else
    font_add(&font_symbol_20_latin_sup, NULL);
#endif
#endif
    ...
    /*SYMBOL 20*/
#if USE_FONT_SYMBOL_20 != 0
#if USE_FONT_DEJAVU_20 != 0
    font_add(&font_symbol_20, &font_dejavu_20);
#else
    font_add(&font_symbol_20, NULL);
#endif
#endif
...
#if USE_FONT_DEJAVU_30_LATIN_SUP != 0
#if USE_FONT_DEJAVU_30 != 0
    font_add(&font_dejavu_30_latin_sup, &font_dejavu_30);
#else
    font_add(&font_dejavu_30_latin_sup, NULL);
#endif
#endif
...
#if USE_FONT_DEJAVU_30 != 0
    font_add(&font_symbol_30, &font_dejavu_30);
#else
...
#if USE_FONT_DEJAVU_40_LATIN_SUP != 0
#if USE_FONT_DEJAVU_40 != 0
    font_add(&font_dejavu_40_latin_sup, &font_dejavu_40);
#else
    font_add(&font_dejavu_40_latin_sup, NULL);
#endif
#endif
    ...
    /*SYMBOL 40*/
#if USE_FONT_SYMBOL_40 != 0
#if USE_FONT_DEJAVU_40 != 0
    font_add(&font_symbol_40, &font_dejavu_40);
#else
    font_add(&font_symbol_40, NULL);
#endif
#endif
